...
- Para E2E/manual com massa `[AI TESTE]`, habilitar a conta apenas durante uma janela explícita de auditoria e obter a credencial fora do repositório
- Não versionar senha de usuário técnico, secrets de infraestrutura, chaves externas ou `.env.local`
