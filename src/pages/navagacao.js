...
export const ROTAS_APP_HEADER = [
  ...
  { path: '/mais', title: 'Mais', tipoTela: TIPOS_TELA.raiz },
  { path: '/app/mais', title: 'Mais', tipoTela: TIPOS_TELA.raiz },
  { path: '/app/perfil', title: 'Meu perfil', tipoTela: TIPOS_TELA.contexto },
  { path: '/app/pontos-qn', title: 'Pontos QN', tipoTela: TIPOS_TELA.contexto },
  { path: '/app/scouts', title: 'Scouts', tipoTela: TIPOS_TELA.contexto },
  { path: '/minhas-partidas', title: 'Partidas', tipoTela: TIPOS_TELA.raiz },
  { path: '/app/meus-jogos', title: 'Partidas', tipoTela: TIPOS_TELA.raiz },
  { path: '/app/minhas-partidas', title: 'Partidas', tipoTela: TIPOS_TELA.raiz },
  { path: '/minhas-partidas-registradas', title: 'Partidas', tipoTela: TIPOS_TELA.raiz },
  ...
  { path: '/grupos/:grupoId', title: 'Grupo', tipoTela: TIPOS_TELA.contexto },
  { path: '/grupos/:grupoId/atletas', title: 'Membros do Grupo', tipoTela: TIPOS_TELA.contexto },
  { path: '/grupos/:grupoId/configuracoes', title: 'Configurações do Grupo', tipoTela: TIPOS_TELA.contexto },
  { path: '/categorias', title: 'Categorias', tipoTela: TIPOS_TELA.raiz },
  { path: '/inscricoes', title: 'Inscrições', tipoTela: TIPOS_TELA.acao },
  { path: '/partidas/registrar', title: 'Nova partida', tipoTela: TIPOS_TELA.acao },
  { path: '/app/registrar-partida', title: 'Nova partida', tipoTela: TIPOS_TELA.acao },
